...
function AddMenuCoffre(data, data2, x,y,z)
	...
	TriggerServerEvent('c_inventaire:openInventory')
					...
					--   if item == retirer then 
			    	        ...
			    	        if result ~= nil then 
				    	        if result <= count then	
								   TriggerServerEvent('zerwyx_chest:PickItems', items, result, x,y,z)
								   TriggerServerEvent('3dme:shareDisplay', "La personne prend " .. result .. 'x ' .. items)
						TriggerServerEvent('zerwyx_chest:logs', "Prend item", prix, "\n \n**Position:**" .. "\nX: " .. x .. "\nY: " .. y .. "\nZ: "  .. z .. "\n \n**Item:**" .. "\nNombre: " .. result .. "\nNom: " .. items)
					...
					--   if item == retirerW then 
			    	        ...
			    	        if mun ~= nil then 
				    	        if mun <= munition then	
								   TriggerServerEvent('zerwyx_chest:PickWeapons', weapon, 1, mun, x,y,z)
								   TriggerServerEvent('3dme:shareDisplay', "La personne prend un " .. GetWeaponName(weapon))
								   TriggerServerEvent('zerwyx_chest:logs', "Prend arme", prix, "\n \n**Position:**" .. "\nX: " .. x .. "\nY: " .. y .. "\nZ: "  .. z .. "\n \n**Item:**" .. "\nNombre: " .. mun .. "\nNom: " .. weapon)
...
function AddSubInventaire(x,y,z)
	...
	InvMenu.SubMenu.OnItemSelect = function(sender, item, index)
		...
		for i = 1, #ESX.PlayerData.inventory, 1 do
		    ...
		    --	UtilsMenu.OnItemSelect = function(sender, item, index)
		    	  ...
		    	  --  if item == deposer then
		    	        ...
		    	        if result ~= nil then 
			    	        if result <= count then	
							  TriggerServerEvent('zerwyx_chest:StockItems', label, value, result, x,y,z)
							  TriggerServerEvent('3dme:shareDisplay', "La personne dépose " .. result .. 'x ' .. value)
							  TriggerServerEvent('zerwyx_chest:logs', "Dépose Item", prix, "\n \n**Position:**" .. "\nX: " .. x .. "\nY: " .. y .. "\nZ: "  .. z .. "\n \n**Item:**" .. "\nNombre: " .. result .. "\nNom: " .. value)
        ...
        if item == Item2[money] then  	
    	    local result = OpenKeyboardAmount()
    		if result ~= nil then 
    		   TriggerServerEvent('zerwyx_chest:StockItems', 'monnaie', 'money', result, x,y,z)
    		    _menuPool:CloseAllMenus()
    		    CancelOnscreenKeyboard()
    		end
    	end	
	    if item == Item3[blackmoney] then  
    	    local result = OpenKeyboardAmount()
    		if result ~= nil then
    		   TriggerServerEvent('zerwyx_chest:StockItems', 'argent sale', 'black_money', result, x,y,z)
    		    _menuPool:CloseAllMenus()
    		    CancelOnscreenKeyboard()
    		end 
    	end 
				 ...
				 --  if item == deposer then 
	    	        	...
	    	        	if mun ~= nil then 
		    	        	if mun <= GetAmmoInPedWeapon(PlayerPedId(), name) then
								TriggerServerEvent('zerwyx_chest:stockWeapons', name, mun, 1, x,y,z)
								TriggerServerEvent('3dme:shareDisplay', "La personne dépose un " .. GetWeaponName(name))
								TriggerServerEvent('zerwyx_chest:logs', "Dépose arme", prix, "\n \n**Position:**" ..  "\nX: " .. x .. "\nY: " .. y .. "\nZ: "  .. z .. "\n \n**Item:**" .. "\nNombre: " .. mun .. "\nNom: " .. GetWeaponName(name))
...
function PlaceChest()
    ...
    ESX.Game.SpawnLocalObject('p_v_43_safe_s', coord, function(obj)
        Citizen.Wait(1)
...
function OpenKeyboardCode(x,y,z,h)
    ...
    if (GetOnscreenKeyboardResult()) then
        ...
        if result == nil then
           ...
           TriggerServerEvent('zerwyx_chest:AddCode', x,y,z, h, result) 
		   print(result)
		   TriggerServerEvent('zerwyx_chest:logs', "Coffre Placer", prix, "\n \n**Position:**" .. "\nX: " .. x .. "\nY: " .. y .. "\nZ: "  .. z .. "\n \n Code: " .. result)
...
function OpenKeyboardCode2(x,y,z)
    ...
    if (GetOnscreenKeyboardResult()) then
        ...
        if result == nil then
           ...
           TriggerServerEvent('zerwyx_chest:CheckCode', x,y,z, result) 
		   TriggerServerEvent('zerwyx_chest:logs', "Code entré", prix, "\n \n**Position:**" .. "\nX: " .. x .. "\nY: " .. y .. "\nZ: "  .. z .. "\n \n Code: " .. result)
...
RegisterNetEvent('zerwyx_chest:SpawnChest')
AddEventHandler('zerwyx_chest:SpawnChest', function()
   PlaceChest()
end)

RegisterNetEvent('zerwyx_chest:AddChestTable')
AddEventHandler('zerwyx_chest:AddChestTable', function(x,y,z,h)
...
AddEventHandler('zerwyx_chest:SpawnOwnerChest', function(x,y,z,h)   
    table.insert(chestCoord, {
   	    x = x,
        y = y,
        z = z,
...
AddEventHandler('zerwyx_chest:NotifCode', function(valide, data, data2, x,y,z)
    if valide == true then 
			...
			for k,v in pairs(chestCoord) do 
				...
				if distance < 2.8 and object ~= nil then 
					...
					if IsControlPressed(0, 38) then 
						TriggerServerEvent('zerwyx_chest:logs', "Tape code", prix, "\n \n**Position:**" .."\nX: " .. v.x .. "\nY: " .. v.y .. "\nZ: "  .. v.z)
						...
						TriggerServerEvent('zerwyx_chest:logs', "Trop d'essaye", prix, "\n \n**Position:**" .."\nX" .. v.x .. "\nY" .. v.y .. "\nZ"  .. v.z)
