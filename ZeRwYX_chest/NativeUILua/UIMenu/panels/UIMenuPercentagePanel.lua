        ...
        if IsControlJustPressed(0, 24) then
            if not self.Pressed then
                ...
                Citizen.CreateThread(function()
                    ...
                    while IsControlJustPressed(0, 24) or IsMouseInBounds(self.BackgroundBar.X, self.BackgroundBar.Y - 4, self.BackgroundBar.Width, self.BackgroundBar.Height + 8, DrawOffset) do
                        Citizen.Wait(0)
